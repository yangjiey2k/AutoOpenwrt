...
# =========================================================
# 【修复 1】强制升级 Golang 版本
# 解决 Passwall 核心组件 (xray/sing-box) 因 Go 版本过低无法编译的问题
# 路径兼容标准 OpenWrt 目录结构 (feeds/packages/lang/golang)
# =========================================================
echo "Force updating Golang to latest version..."
...
# =========================================================
# 【修复 2】添加 Passwall 依赖库 (packages)
# 必须先拉取这个，否则 Passwall 主程序会因缺依赖被跳过
# =========================================================
...
# =========================================================
# 【修复 3】注释掉 Sing-box 的手动版本更新
# 避免破坏 passwall_packages 里的版本兼容性
# =========================================================
